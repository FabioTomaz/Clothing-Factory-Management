...
CREATE TABLE [PRODUTO-PERSONALIZADO](
	...
	PRIMARY KEY(REFERENCIA, TAMANHO, ID)
);

CREATE TABLE [PRODUTO-PERSONALIZADO-DETALHES](
	REFERENCIA			INT				REFERENCES [PRODUTO-BASE](REFERENCIA),
	ID					INT				,
...
CREATE TABLE CONTEUDO_ENCOMENDA(
	...
	FOREIGN KEY(REFERENCIA_PRODUTO, TAMANHO_PRODUTO, ID_PRODUTO) REFERENCES [PRODUTO-PERSONALIZADO](REFERENCIA, TAMANHO, ID),
	PRIMARY KEY(N_ENCOMENDA, REFERENCIA_PRODUTO, TAMANHO_PRODUTO, ID_PRODUTO)
);
...
CREATE TABLE [MATERIAIS-PRODUTO](
	...
	FOREIGN KEY ( REFERENCIA, TAMANHO, ID )	REFERENCES [PRODUTO-PERSONALIZADO]( REFERENCIA, TAMANHO, ID ),
	PRIMARY KEY(REFERENCIA, TAMANHO, ID, REFERENCIA_FABRICA)
);
...
HORA_ENTRADA, HORA_SAIDA, CODPOSTAL1, CODPOSTAL2, RUA, N_PORTA) VALUES
	('Fabio Silva', 'bsfmts@gmail.com', 1250, EncryptByPassPhrase('ThePassphrase', 'qwerty'), 91547855, 1, '09:00:00 AM', '18:00:00 PM', 4650,308, 'Rua da Beira', 17);
...
--SELECT [PRODUTO-PERSONALIZADO].REFERENCIA as REF, [PRODUTO-BASE].NOME , [PRODUTO-PERSONALIZADO].TAMANHO AS TAM, [PRODUTO-PERSONALIZADO-DETALHES].COR AS COLOR, 
--[PRODUTO-PERSONALIZADO].ID AS IDENT, [PRODUTO-PERSONALIZADO].PRECO AS PRICE, [PRODUTO-PERSONALIZADO].UNIDADES_ARMAZEM AS UA, CONTEUDO_ENCOMENDA.QUANTIDADE AS QT
-- FROM ENCOMENDA JOIN [PRODUTO-PERSONALIZADO-DETALHES] ON ([PRODUTO-PERSONALIZADO-DETALHES].REFERENCIA = [PRODUTO-PERSONALIZADO].REFERENCIA
...
-- AND CONTEUDO_ENCOMENDA.COR_PRODUTO = [PRODUTO-PERSONALIZADO-DETALHES].COR
