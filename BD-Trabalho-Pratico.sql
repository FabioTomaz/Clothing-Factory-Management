...
CREATE TABLE CLIENTE(
	...
	COD_POSTAL			VARCHAR(10)		NOT NULL REFERENCES ZONA(COD_POSTAL),
...
CREATE TABLE ENCOMENDA(
	...
	DESCONTO			DECIMAL(5,2)	NOT NULL DEFAULT 0.00 CHECK(DESCONTO>=0.00 AND DESCONTO<=1.00),
	ESTADO				VARCHAR(15)		NOT NULL,
	CLIENTE				CHAR(9)			NOT NULL REFERENCES CLIENTE(NIF) ON UPDATE CASCADE,
...
CREATE TABLE ETIQUETA(
	NUMERO_DESENHO		INT				PRIMARY KEY REFERENCES DESENHO(N_DESENHO) ON UPDATE CASCADE,
...
CREATE TABLE FORNECEDOR(
	...
	COD_POSTAL			VARCHAR(10)		REFERENCES ZONA(COD_POSTAL),
	RUA					VARCHAR(40)		NOT NULL,
	N_PORTA				INT				NOT NULL CHECK(N_PORTA>0)
);
