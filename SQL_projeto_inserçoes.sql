...
HORA_ENTRADA, HORA_SAIDA, CODPOSTAL1, CODPOSTAL2, RUA, N_PORTA) VALUES
	('Carlos Costa', 'costa@mail.pt', 1500, 'qwe', 91547855, 1, '09:00:00 AM', '18:00:00 PM', 4650,308, 'rua da Beira', 17)
...
INSERT INTO [MATERIAIS-PRODUTO] (REFERENCIA, TAMANHO, COR, ID, REFERENCIA_FABRICA, QUANTIDADE) VALUES
	(1, 'XL', 'azul escuro', 1 , 2 , 1),
	(1, 'XL', 'azul escuro', 1 , 1 , 5),
	(1, 'XL', 'verde lima', 2 , 1 , 2),
	(2, 'M', 'azul claro', 3 , 5 , 1),
	(2, 'M', 'Amarelo', 4, 9, 1);
