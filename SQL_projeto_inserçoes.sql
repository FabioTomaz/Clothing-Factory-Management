...
INSERT INTO CLIENTE (NOME, NIB, NIF, EMAIL, TELEMOVEL, COD_POSTAL, RUA, N_PORTA) VALUES
	...
	('Fabio Tomas', 452178500452014789652, 888666555, 'fmts566@ua.pt', 967061447, '1254-585', 'Rua do Beco', 15);
...
HORA_ENTRADA, HORA_SAIDA, COD_POSTAL, RUA, N_PORTA, N_FUNCIONARIO_SUPER) VALUES
	('Carlos Costa', 'costa@mail.pt', 1500, 'qwe', 91547855, 1, '09:00:00 AM', '18:00:00 PM', '2288-227', 'rua da Beira', 17, 1),
...
INSERT INTO ENCOMENDA (DATA_CONFIRMACAO, DATA_ENTREGA_PREV, LOCALENTREGA, ESTADO, CLIENTE, N_GESTOR_VENDA) VALUES
	...
	('20170515', '20170602', NULL, 2, 1, 3),
	('20170522', '20170802', NULL, 3, 2, 3),
	('20170528', '20170704', NULL, 2, 3, 3);
...
SELECT N_ENCOMENDA, DATA_CONFIRMACAO, DATA_ENTREGA, LOCALENTREGA, ESTADO, N_GESTOR_VENDA, UTILIZADOR.NOME AS GESTOR_NOME FROM ENCOMENDA JOIN 
  UTILIZADOR ON N_FUNCIONARIO = N_GESTOR_VENDA WHERE CLIENTE = 1